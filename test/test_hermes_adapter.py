...
class HermesAdapterTests(unittest.TestCase):
    ...
    def test_register_exposes_proof_tool_command_and_skill(self) -> None:
        ...
        self.assertIn("tinyhat_computer_desktop", ctx.tools)
        ...
        self.assertIn("tinyhat-computer-desktop", ctx.skills)
        ...
        self.assertTrue(ctx.skills["tinyhat-computer-desktop"].is_file())
    ...
    def test_registered_tool_schemas_are_agent_actionable(self) -> None:
        ...
        allocation_schema = schemas.TINYHAT_OPENROUTER_CREDIT_ALLOCATE_SCHEMA
        self.assertEqual(allocation_schema["required"], ["amount_cents"])
        self.assertEqual(
            allocation_schema["properties"]["amount_cents"]["minimum"],
            100,
        )
        self.assertNotIn("user_id", allocation_schema["properties"])
        self.assertNotIn("agent_id", allocation_schema["properties"])
    ...
    def test_plugin_version_returns_live_manifest_version(self) -> None:
        ...
        self.assertEqual(payload["version"], "0.32.23")
    ...
    def test_running_version_contract_stays_at_plugin_root(self) -> None:
        ...
        self.assertEqual(tools._plugin_manifest()["version"], "0.32.23")
    ...
    def test_platform_status_uses_attested_computer_endpoint(self) -> None:
        ...
        class FakePlatformClient:
            def get_json(self, path: str) -> dict[str, object]:
                ...
                return {
                    ...
                    "state": "active",
                    "assigned": True,
                    "package_inventory": {"plugin": {"version": "0.28.0"}},
                }
        ...
        self.assertEqual(payload["package_inventory"]["plugin"]["version"], "0.28.0")
    ...
    def test_skill_catalog_lists_qualified_names_and_aliases(self) -> None:
        ...
        self.assertEqual(payload["plugin"]["version"], "0.32.23")
    ...
    def test_context_hook_injects_for_funding_questions(self) -> None:
        examples = (
            ...
            "Check my balance?",
            "Add $5 of my credit to this agent's OpenRouter model budget",
            "Charge this agent's OpenRouter key with ten dollars",
        )
        for user_message in examples:
            with self.subTest(user_message=user_message):
                injected = tinyhat_context.inject_tinyhat_context(
    ...
    def test_context_states_funding_reminder_rules(self) -> None:
        ...
        self.assertIn("A simple greeting gets one or two short sentences", directive)
        self.assertIn("Mention funding only when they ask", directive)
    ...
    def test_codex_auth_skill_states_funding_model(self) -> None:
        ...
        self.assertIn("without a funding pitch", text)
