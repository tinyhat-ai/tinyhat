...
| Ask for the current Tinyhat credit balance, recent transactions, or a Computer usage charge | Load `tinyhat:tinyhat-credit` and call `tinyhat_credit`. Use the Computer name and charged time range when explaining a Computer charge. |
