...
| `capabilities/account_upgrade/` | Upgrade the assigned individual owner for Stripe Projects after explicit approval. |
...
| `skills/tinyhat-account-upgrade/SKILL.md` | Offer and complete an individual account upgrade using the existing Computer identity; no duplicate sign-up or service purchase. |
