...
- `services/`: Computer-scoped Stripe Projects catalog and autonomous budgeted Project, Provider, and Resource operations after one owner authorization, including account-resource attachment.
