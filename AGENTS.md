...
| Author or sharpen a development skill | [`skill-authoring`](.claude/skills/skill-authoring/SKILL.md) | Before adding a new `.claude/skills/<name>/SKILL.md` or editing an existing one. Covers the evidence bar, trigger-first authoring, frontmatter rules, the quality checklist, and the validation step. |
