...
| `tinyhat_services` | Platform API required | Discovers the current Stripe Projects catalog, manages this Computer's Project, and prepares Provider, Resource, and account-resource Project association changes for a signed-in owner to review before one-time submission. |
