...
up to ten recent transactions. The plugin projects only those documented
...
The operation accepts no user, account, Stripe, or transaction identifier and does
