...
onboarding reminder is directed by the platform context with a durable
marker; tool-owned native first replies satisfy it, and the agent must
never state a remaining credit balance it cannot see.
