...
- For Hats, load tinyhat:hat-authoring. Use tinyhat_hats to create, inspect, rename, edit repo files, or list/remove Hat credentials. Repo files must never contain secrets. Add or replace a Hat credential with tinyhat_private_secret_handoff plus hat_identifier; the browser encrypts it and the Computer stores it locally.
