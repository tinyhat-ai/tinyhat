...
- Hat create/edit/delete: load tinyhat:hat-authoring. Skill writing: load tinyhat:tinyhat-skill-authoring. Pasted owner/hats/name or pending install: load tinyhat:tinyhat-hat-wearing. Repo files never contain secrets. Creator values move only as consumer-key ciphertext and open on the consumer Computer. Never reveal them.
